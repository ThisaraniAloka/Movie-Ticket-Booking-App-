  ...
  return (
     <footer className="px-6  md:px-16 lg:px-36 mt-40 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                      CINEASIA brings you the latest movies and seamless ticket booking at your fingertips. Enjoy exclusive offers, showtimes, and personalized recommendations. Follow us for updates and stay connected with the world of cinema
                    </p>
            ...
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="">Thisarani Aloka</a>. All Right Reserved.
            </p>
        </footer>
  )
}
